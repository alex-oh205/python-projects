...
class Camera:
    ...
    def update(self, target):
        ...
        self.x = -target.rect.centerx + int(WIDTH / 2) - (mousex + WIDTH / 2) * self.mouse_limit * 2 / WIDTH
        self.y = -target.rect.centery + int(HEIGHT / 2) - (mousey + HEIGHT / 2) * self.mouse_limit * 2 / HEIGHT
