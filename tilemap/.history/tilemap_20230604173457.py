...
class Camera:
    ...
    def update(self, target):
        ...
        self.targetx = -self.target.rect.centerx + int(WIDTH / 2) - (mousex - WIDTH / 2) * self.mouse_limit * 2 / (3 * WIDTH)
        self.targety = -self.target.rect.centery + int(HEIGHT / 2) - (mousey - HEIGHT / 2) * self.mouse_limit * 2 / (3 * HEIGHT)
    ...
    def focus(self, obj, time):
        self.start_focus = pg.time.get_ticks()
