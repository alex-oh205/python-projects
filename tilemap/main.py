...
class Game:
    ...
    def update(self):
        ...
        if len(self.mobs) == 0:
            if self.boss:
                if self.win_delay_start == 0:
                    self.win_delay_start = pg.time.get_ticks()
                if pg.time.get_ticks() - self.win_delay_start > 2000:
                    self.playing = False
                    self.win = True
            else:
                for tile_object in self.map.tmxdata.objects:
    ...
    def draw(self):
        ...
        for sprite in self.all_sprites:
            try:
                if not isinstance(sprite, (Crosshair, Inventory)):
    ...
    def show_start_screen(self):
        ...
        self.draw_text("Arrow keys or WASD to move", self.title_font, 30, WHITE, WIDTH / 2, HEIGHT / 2 - 75, align="center")
        self.draw_text("Click to shoot", self.title_font, 30, WHITE, WIDTH / 2, HEIGHT / 2 - 45, align="center")
        self.draw_text("E to show/hide inventory", self.title_font, 30, WHITE, WIDTH / 2, HEIGHT / 2 - 15, align="center")
        self.draw_text("P to pause", self.title_font, 30, WHITE, WIDTH / 2, HEIGHT / 2 + 15, align="center")
        self.draw_text("H to show hitboxes", self.title_font, 30, WHITE, WIDTH / 2, HEIGHT / 2 + 45, align="center")
        self.draw_text("N to toggle night mode", self.title_font, 30, WHITE, WIDTH / 2, HEIGHT / 2 + 75, align="center")
